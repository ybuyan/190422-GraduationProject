...
var _lang = {
    ...
    zh: {
        title: "袜中找妹",
        help_txt: "在众多<span style='font-size:240%'>袜</span>字中找到唯一的<span style='font-size:240%'>妹</span>字",
        score: "过关：",
        btn_pause: "暂停",
        btn_start: "开始游戏",
        btn_reTry: "再来一次",
...
shareData = {
    imgUrl: "http://www.5kym.com/games/zhaonimei/zhaonimei.jpg",
    timeLineLink: "http://www.5kym.com/games/zhaonimei/",
...
function(a) {
    ...
    f = {
        init: function() {
            this.initEvent(),
            this.loading(),
            /android/i.test(c) ? (b.banner.attr("href", "http://www.5kym.com/").data("type", "android").find("img").attr("src", "assets/img/banner.android.jpg"), b.banner.show()) : /iphone|ipad|ipod/i.test(c) && (b.banner.attr("href", "http://www.5kym.com/").data("type", "ios").find("img").attr("src", "assets/img/banner.ios.jpg"), b.banner.show())
        },
        loading: function() {
            function a() {
                d++,
